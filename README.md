...
- Installing Nerd Font
  - Pick font file from JetBrainsMono.zip (e.g JetBrainsMonoNerdFontMono-Regular.ttf)
  - Copy the font file to system's font folder (Linux Mint: ~/.local/share/fonts)
  - Set terminal font to the selected font
  - Restart terminal
- Install 'ripgrep' for telescope grep feature
  - Linux mint: sudo apt-get install ripgrep
